      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-4">
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <div className="flex-1 min-w-64">
            <input
              type="text"
              placeholder="Search by name, tenant ID, or customer ID..."
              value={searchTerm}
          ...
          {/* Clear Filters */}
          {(filters.status || filters.region || filters.priority || filters.deploymentType || searchTerm) && (
            <button
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="text-sm">
                      <div className="text-gray-900 dark:text-white font-mono text-xs">{customer.tenantId}</div>
                      <div className="text-gray-500 font-mono text-xs">{customer.propertyId}</div>
                    </div>
                  </td>
